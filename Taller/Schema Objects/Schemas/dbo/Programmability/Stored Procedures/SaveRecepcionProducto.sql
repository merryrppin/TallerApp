...
BEGIN
	...
	BEGIN TRY	
		BEGIN TRANSACTION
			...
			INSERT INTO [dbo].[tblProductosRecepcionProductoValues] ([IdProductoRecepcionProducto], [IdProduct], [IdProductProperty], [ValueOption])
				SELECT  prodCot.[IdProductoRecepcionProducto], IdProduct, IdProductProperty, [Value]
